...
import ua.shuriak.animage.adapter.DanbooruAdapter;
import ua.shuriak.animage.object.DanbooruObject;


public class DanbooruFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new DanbooruAdapter(context,list);
    ...
    void request(final boolean loadMore){
        ...
        String url = "http://danbooru.donmai.us/posts.json?page="+page+
    ...
    List<DanbooruObject> getList(String json){
        Gson gson = new Gson();
        Type listType = new TypeToken<List<DanbooruObject>>(){}.getType();
