...
public class SafebooruAdapter extends RecyclerView.Adapter<ViewHolder> {

    Context context;
    List<SafebooruObject.Post> list;

    public SafebooruAdapter(Context context, List<SafebooruObject.Post> list){
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final SafebooruObject.Post image = list.get(position);
